...
<html>
	...
	<body>
		<a href="#edit-help" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-help" class="content scaffold-edit" role="main">
